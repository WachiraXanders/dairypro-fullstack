  ...
  return (
    <div className="space-y-6">
        ...
        <CardContent className="pt-5">
          <div className="flex flex-wrap gap-4 items-end">
            <div className="flex flex-col gap-1">
              <label className="text-xs text-slate-500 font-medium">Forecast Period</label>
            ...
            <div className="flex flex-col gap-1">
              <label className="text-xs text-slate-500 font-medium">Historical Lookback</label>
            ...
            {activeScenario === 'custom' && (
              <>
                <div className="flex flex-col gap-1">
                  <label className="text-xs text-slate-500 font-medium">Milk Price (Kshs/L)</label>
                ...
                <div className="flex flex-col gap-1">
                  <label className="text-xs text-slate-500 font-medium">Herd Multiplier</label>
                ...
                <div className="flex flex-col gap-1">
                  <label className="text-xs text-slate-500 font-medium">Expense Growth %/mo</label>
      ...
      <div className="flex items-center gap-2">
        ...
        <span className="font-semibold text-slate-700">{currentScenario.label} Scenario</span>
        <span className="text-sm text-slate-500">— {currentScenario.description}</span>
              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  {activeForecast.map((row, i) => (
                    <tr key={row.month} className={cn('border-b', i % 2 === 0 ? 'bg-slate-50/50' : '')}>
                      ...
                      <td className="py-2 pr-4 text-right text-slate-600">{row.milkPrice}</td>
              ...
              <Card key={s.id} className={cn('cursor-pointer transition-all border-2', activeScenario === s.id ? 'border-current shadow-md' : 'border-transparent')}
                ...
                <CardHeader className="pb-2">
                  <CardTitle className="text-sm flex items-center gap-2">
                    ...
                    {s.label}
                    <span className="font-normal text-slate-500 ml-1">— {s.description}</span>
                  </CardTitle>
                </CardHeader>
                <CardContent>
