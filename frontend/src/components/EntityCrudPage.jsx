      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <h1 className="text-2xl font-semibold text-slate-900 flex items-center gap-2">
            {Icon && <Icon className="w-6 h-6 text-emerald-600" />} {title}
          </h1>
      ...
      <Card>
        <CardContent className="p-0">
          {isLoading ? (
            ...
            <p className="text-center py-16 text-slate-400 text-sm">No records yet.</p>
          ) : (
                    ...
                    <TableRow key={row.id}>
                      ...
                      {canWrite && (
                        <TableCell className="text-right space-x-1">
                          ...
                          <Button variant="ghost" size="icon" onClick={() => setDeleteTarget(row)}><Trash2 className="w-4 h-4 text-red-500" /></Button>
                        </TableCell>
                      )}
                    </TableRow>
                  ))}
