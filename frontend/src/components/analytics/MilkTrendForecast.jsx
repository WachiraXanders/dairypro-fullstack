  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-lg font-semibold text-slate-800">Milk Production Forecast</h2>
          <p className="text-sm text-slate-500 mt-1">AI-powered 3-month production predictions</p>
        </div>
      ...
      {!forecast ? (
        <Card className="border-dashed">
          <CardContent className="flex flex-col items-center justify-center py-12">
            ...
            <h3 className="text-lg font-semibold text-slate-800 mb-2">No Forecast Yet</h3>
        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent>
              ...
              <div className="space-y-2">
                <h4 className="font-semibold text-sm text-slate-700">Key Factors:</h4>
