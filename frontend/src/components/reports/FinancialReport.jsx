    ...
    <div className="space-y-6">
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          {/* By Category */}
          <div>
            <h3 className="font-semibold text-slate-800 mb-3">Transactions by Category</h3>
          ...
          {/* Detailed Table */}
          <div>
            <h3 className="font-semibold text-slate-800 mb-3">Transaction Details ({filteredData.length})</h3>
                ...
                <TableBody>
                  {filteredData.map((txn) => (
                    <TableRow key={txn.id}>
                      ...
                      <TableCell className="text-slate-500">{txn.payment_method || '-'}</TableCell>
                    </TableRow>
                  ))}
                </TableBody>
              </Table>
