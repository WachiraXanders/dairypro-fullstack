    ...
    <div className="space-y-6">
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          {/* By Type */}
          <div>
            <h3 className="font-semibold text-slate-800 mb-3">Records by Type</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
              {Object.entries(summary.byType).map(([type, data]) => (
                <div key={type} className="bg-white border rounded-lg p-3">
                  ...
                  <p className="text-xs text-slate-500">Kshs {data.cost.toFixed(2)}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          {/* By Cattle */}
          <div>
            <h3 className="font-semibold text-slate-800 mb-3">Records by Cattle</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
              {Object.values(summary.byCattle).map((cow, idx) => (
                <div key={idx} className="bg-white border rounded-lg p-3">
                  ...
                  <p className="text-xs text-slate-500">Kshs {cow.cost.toFixed(2)}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          {/* Detailed Table */}
          <div>
            <h3 className="font-semibold text-slate-800 mb-3">Health Records ({filteredData.length})</h3>
                  ...
                  {filteredData.map((record) => {
                    ...
                    return (
                      <TableRow key={record.id}>
                        ...
                        <TableCell className="text-slate-600">{record.treatment || '-'}</TableCell>
