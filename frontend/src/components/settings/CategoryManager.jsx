  ...
  return (
    <div className="bg-white rounded-2xl border border-slate-100 p-6">
      <div className="flex items-center gap-3 mb-5">
        ...
        <div>
          <h3 className="font-semibold text-slate-800">{ctx.label}</h3>
          <p className="text-sm text-slate-500">{ctx.description}</p>
        </div>
      </div>
      ...
      <p className="text-xs text-slate-400 mt-2">Default categories (shown without ✕) cannot be removed. Custom ones can be deleted.</p>
    </div>
  );
}
