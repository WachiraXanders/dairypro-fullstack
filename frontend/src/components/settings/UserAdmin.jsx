...
const ROLES = [
  ...
  { value: 'viewer', label: 'Viewer', color: 'bg-slate-100 text-slate-600', icon: User },
];
      ...
      <div className="bg-white rounded-2xl border border-slate-100 p-6">
        <div className="flex items-center gap-3 mb-5">
          ...
          <div>
            ...
            <p className="text-sm text-slate-500">Send an email invitation to a new team member</p>
          </div>
        </div>
