                ...
                return (
                  <button
                    ...
                    className={cn(
                      ...
                      today ? "border-emerald-400 bg-emerald-50" : "border-transparent hover:border-slate-200 hover:bg-slate-50",
                      isSelected && "border-emerald-500 bg-emerald-50 ring-1 ring-emerald-400"
                    )}
                  >
                    <span className={cn(
                      "text-xs font-medium block text-center",
                      today ? "text-emerald-700 font-bold" : "text-slate-600"
                    )}>
                      {format(day, 'd')}
                    </span>
        ...
        <Card>
          ...
          <CardContent>
            {upcomingEvents.length === 0 ? (
              <p className="text-sm text-slate-400 text-center py-6">No upcoming events in the next 30 days</p>
            ) : (
