      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <h1 className="text-2xl font-semibold text-slate-900 flex items-center gap-2">
            <HeartPulse className="w-6 h-6 text-emerald-600" /> Health Records
          </h1>
          <p className="text-sm text-slate-500 mt-1">Track vaccinations, treatments, and checkups.</p>
        </div>
      ...
      <Card>
        <CardContent className="p-0">
          {isLoading ? (
            ...
            <p className="text-center py-16 text-slate-400 text-sm">No health records yet.</p>
          ) : (
